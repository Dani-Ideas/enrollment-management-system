...
// strings y viajan JUNTO con la Inscripcion en la misma peticion (ver crearInscripcionConFormaciones,
// InscripcionCompuestaRequestDTO) -- el backend resuelve el FK internamente. Al ACTUALIZAR,
// cada fila ya tiene su id real (o null si se agrego durante la edicion) -- ver
// FormacionComplementariaEditable/formacionesOriginalRef mas abajo.
