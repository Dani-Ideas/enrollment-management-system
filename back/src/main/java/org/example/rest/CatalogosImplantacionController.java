...
import static org.example.rest.ApplicationConfig.Endpoints.CATALOGOS_IMPLANTACION;

// Un solo endpoint, un solo GET: "tablas genericas" -- los 4 catalogos
// (estados/sistemas/responsables/ambientes) que hoy pide el formulario de implantacion
...
@Path(CATALOGOS_IMPLANTACION)
@Produces(MediaType.APPLICATION_JSON)
public class CatalogosImplantacionController {
    ...
    public Response tablas() {
        return Response.ok(serviceArtifax.tablasImplantacion()).build();
    }
}
